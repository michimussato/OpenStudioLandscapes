...
subprocess.run([shutil.which("apt-get"), "update"])
subprocess.run([shutil.which("apt-get"), "upgrade", "-y"])

subprocess.run([shutil.which("apt-get"), "install", "-y", "openssh-server", "git", "htop", "vim"])
subprocess.run([shutil.which("apt-get"), "-y", "autoremove"])
subprocess.run([shutil.which("apt-get"), "clean"])


subprocess.run([shutil.which("systemctl"), "clean"])
