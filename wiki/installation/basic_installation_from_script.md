...
```shell
python3 <(curl --header 'Cache-Control: no-cache, no-store' --silent https://raw.githubusercontent.com/michimussato/OpenStudioLandscapes/refs/tags/v1.1.0/installer/ubuntu/22.04/install_ubuntu_2204.py)
```
