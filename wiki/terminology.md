...
| **Compose Scope**  | A Landscape can be broken up into multiple Compose Scopes. For example, a render client will run on a different machine than the render manager - they are part of the same Langscape but belong to separate docker compose files.     |     |
