...
graph TB
    ...
    click clone_repo_manual "/installation/basic_installation.md#clone-repository"
    %% clone_repo_docker[Clone OpenStudioLandscapes Repository]
    %% click clone_repo_docker "/installation/basic_installation.md#clone-repository"
    ...
    click landscapes_root_manual "/installation/basic_installation.md#create-landscapes-root-directory"
    %% landscapes_root_docker[Create Landscapes Root Directory]
    %% click landscapes_root_docker "/installation/basic_installation.md#create-landscapes-root-directory"
    landscapes_root_script[Create Landscapes Root Directory]
    click landscapes_root_script "/installation/basic_installation.md#create-landscapes-root-directory"
    ...
    click install_python_manual "/installation/basic_installation.md#install-python311"
    %% install_python_docker[Install Python 3.11]
    %% click install_python_docker "/installation/basic_installation.md#install-python311"
    ...
    click install_docker_manual "/installation/basic_installation.md#install-docker"
    %% install_docker_docker[Install Docker]
    %% click install_docker_docker "/installation/basic_installation.md#install-docker"
    ...
    click install_harbor_manual "/installation/basic_installation.md#harbor"
    %% install_harbor_docker[Install Harbor]
    %% click install_harbor_docker "/installation/basic_installation.md#harbor"
    ...
    click run_harbor_manual "run/run_harbor.md#up"
    %% run_harbor_docker[Run Harbor]
    %% click run_harbor_docker "run/run_harbor.md#up"
    ...
    click clone_features_manual "/installation/install_features.md#clone-features"
    class clone_features_manual clone_features

    classDef install_features fill:#654321;
    install_features_manual[Install Features]
    click install_features_manual "/installation/install_features.md#install-features-1"
    class install_features_manual install_features

    classDef run fill:#142536;
    run_manual(Run OpenStudioLandscapes)
    click run_manual "run_openstudiolandscapes/from_manual.md#up"
    %% run_docker(Run OpenStudioLandscapes)
    %% click run_docker "run_openstudiolandscapes/from_docker_image.md"
    run_script(Run OpenStudioLandscapes)
    click run_script "run_openstudiolandscapes/from_script.md#up-and-down"
