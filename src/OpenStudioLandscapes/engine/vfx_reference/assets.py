...
"""
VFX Platform Reference
- https://vfxplatform.com/
- https://github.com/AcademySoftwareFoundation/aswf-docker
- https://gist.github.com/alu-dmikolaj/a8b06a4d9b0edb47e1cbd8c0782659fe
...
def write_dockerfile_CY2026(
    ...
    #         *openstudiolandscapes__rez_config.apt_packages_rez,
    #     ],
    # )
    ...
    docker_file_str = textwrap.dedent("""\
        ...
        ################################################################################
        # Multi Stage: Stage 1
        FROM {rocky_image}:{rocky_base} AS base
        ...
        # altinstall instead of install because the later command will overwrite the default system python{python_maj} binary.
        ...
        #     "time",
        # ]),
        rocky_image="docker.io/rockylinux",
        rocky_base=[
            "8",
            "9",
            "10",
