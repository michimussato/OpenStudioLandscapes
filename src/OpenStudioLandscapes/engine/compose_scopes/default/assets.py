    ...
    @asset(
        **ASSET_HEADER_COMPOSE,
        ...
        description=textwrap.dedent(
            ...
            ```shell
            OPENSTUDIOLANDSCAPES__PANGOLIN_SITE__COMPOSE_SCOPE_{COMPOSE_SCOPE.upper()}__NEWT_ID=$NEWT_ID \\
            OPENSTUDIOLANDSCAPES__PANGOLIN_SITE__COMPOSE_SCOPE_{COMPOSE_SCOPE.upper()}__NEWT_SECRET=$NEWT_SECRET \\
            OPENSTUDIOLANDSCAPES__PANGOLIN_SITE__COMPOSE_SCOPE_{COMPOSE_SCOPE.upper()}__PANGOLIN_ENDPOINT=$PANGOLIN_ENDPOINT \\
