...
for i in IMPORTED_FEATURES:
    ...
    if compose_scope == ComposeScope.TELEPORT:
        split = module.split(".")
...
if bool(ins):
        ...
        **ASSET_HEADER_COMPOSE_TELEPORT,
        ins={
            ...
            "DOCKER_COMPOSE": AssetIn(
                AssetKey(
                    [
                        *ASSET_HEADER_COMPOSE_TELEPORT["key_prefix"],
                        "DOCKER_COMPOSE",
                    ]
                )
            ),
    ...
    #         f"{ASSET_HEADER_COMPOSE_TELEPORT['group_name']}__{'__'.join(ASSET_HEADER_COMPOSE_TELEPORT['key_prefix'])}",
    ...
    group_out = get_group_out(
        ASSET_HEADER=ASSET_HEADER_COMPOSE_TELEPORT,
    )

    docker_compose_graph = AssetsDefinition.from_op(
        op_docker_compose_graph,
        group_name=ASSET_HEADER_COMPOSE_TELEPORT["group_name"],
        key_prefix=ASSET_HEADER_COMPOSE_TELEPORT["key_prefix"],
        keys_by_input_name={
            "group_out": AssetKey(
                [*ASSET_HEADER_COMPOSE_TELEPORT["key_prefix"], "group_out"]
            ),
