...
def write_dockerfile(
    ...
    apt_install_str_base: str = get_apt_install_str(
        apt_install_packages=[
            *config_ConfigEngineConfigurableResource.apt_packages_base,
            *config_RezConfigurableResource.apt_packages_rez,
        ],
    )

    apt_install_str_build_python311: str = get_apt_install_str(
        apt_install_packages=config_ConfigEngineConfigurableResource.apt_packages_build_python311,
    )

    pip_install_str: str = get_pip_install_str(pip_install_packages=config_ConfigEngineConfigurableResource.pip_packages)
