    ...
    **kwargs,
    ...
    def _op_compose_scope__group_out(
        ...
        **kwargs,
        ...
        asset_key_systemd_unit = context.asset_key_for_output(output_name='systemd_unit').path
        ...
        systemd_unit_shell = textwrap.dedent(f"""
            ...
            # systemctl --user is-active openstudiolandscapes-{compose_scope}@${{USER}}.service
            # 
            # Is the service enabled?
            # systemctl --user is-enabled openstudiolandscapes-{compose_scope}@${{USER}}.service
            # 
            # Important:
