    ...
    def _op_compose_scope__group_out(
        ...
        **kwargs,
        ...
        systemd_unit = textwrap.dedent(f"""
            [Unit]
            # AUTO-GENERATED by Dagster Asset {'__'.join(asset_key_systemd_unit)}
            ...
            # IMPORTANT:
            # OpenStudioLandscapes *MUST NOT* RUN AS ROOT
        ...
        systemd_unit_shell = textwrap.dedent(f"""
            ...
            # sudo systemctl is-active openstudiolandscapes-{compose_scope}.service
            # 
            # Is the service enabled?
            # sudo systemctl is-enabled openstudiolandscapes-{compose_scope}.service
            # 
            # Important:
            # We have to stop and disable a currently running service before changing
            ...
            sudo systemd-analyze verify openstudiolandscapes-{compose_scope}.service
            
            # Re-enable the service with:
