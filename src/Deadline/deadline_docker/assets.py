...
def build_base_image(
    ...
    docker_file = pathlib.Path(
        f"~/git/repos/deadline-docker/.docker/10.2/Dockerfiles/{context.asset_key.path[0]}/Dockerfile"
    ).expanduser()
    tags = [
...
def compose_repository_10_2(
        ...
        "services": {
            "repository-10-2": {
                ...
                "command": [
                    ...
                    "--prefix", env_10_2.get("REPOSITORY_INSTALL_DEST_TEST_10_2"),
                    "--dbtype", "MongoDB",
    ...
    docker_compose = pathlib.Path(
        f"~/git/repos/deadline-docker/.docker/10.2/docker_compose/{context.asset_key.path[0]}/docker-compose.yaml",
    ).expanduser()
...
def compose_10_2(
    ...
    docker_compose = pathlib.Path(
        f"~/git/repos/deadline-docker/.docker/10.2/docker_compose/"
